...
export const kentonLocations = {
  ...
  moms_house: {
    ...
    npcSlots: [],
    actionIds: ['raid_fridge', 'stare_at_ceiling', 'sleep'],
    discovered: true,
  ...
  blue_parrot: {
    ...
    npcSlots: [],
    actionIds: ['order_beer_parrot', 'talk_to_bartender_parrot'],
    discovered: false,
  ...
  mocks_crest: {
    ...
    npcSlots: [],
    actionIds: ['order_beer_mocks', 'play_pool_mocks'],
    discovered: false,
  ...
  columbia_park: {
    ...
    npcSlots: [],
    actionIds: ['sit_on_bench', 'look_for_change'],
    discovered: false,
    availability: { openHour: 0, closeHour: 23, closedMessage: null },
    visitCount: 0,
  },
  ...
  arbys: {
    ...
    // TODO: add eat_curly_fries action in Phase 3 content pass
    visitCount: 0,
  },
  ...
  ainsworth_plaid: {
    ...
    npcSlots: [],
    actionIds: ['buy_tallboy', 'shoplift_plaid'],
    discovered: false,
    availability: { openHour: 0, closeHour: 23, closedMessage: null },
    visitCount: 0,
  },
