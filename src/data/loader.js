...
const SOURCES = {
  ...
  [CONTENT_KINDS.acts]: import.meta.glob('/content/acts/*.json', { eager: true }),
  [CONTENT_KINDS.cures]: import.meta.glob('/content/cures/*.json', { eager: true }),
  ...
  [CONTENT_KINDS.marks]: import.meta.glob('/content/marks/*.json', { eager: true }),
  [CONTENT_KINDS.psycheTables]: import.meta.glob('/content/psyche/*.json', { eager: true }),
  [CONTENT_KINDS.topics]: import.meta.glob('/content/topics/*.json', { eager: true }),
